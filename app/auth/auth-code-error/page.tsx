      ...
      <div className="flex min-h-[calc(100vh-160px)] flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          <div className="text-center">
            ...
            <h1 className="mt-4 text-3xl font-bold text-gray-900">Email Verification Failed</h1>
            <p className="mt-2 text-sm text-gray-600">
              There was an issue verifying your email address. This could be due to an expired or invalid link.
            </p>
          </div>
        </div>
              ...
              <div className="rounded-md bg-yellow-50 border border-yellow-200 p-4">
                <div className="text-sm text-yellow-700">
                  ...
                  <ul className="list-disc list-inside space-y-1">
                    <li>Check if the email link has expired</li>
                    <li>Request a new verification email</li>
                    <li>Make sure you're using the same browser and device</li>
                    <li>Try logging in if your account was already verified</li>
                  </ul>
                </div>
              </div>
