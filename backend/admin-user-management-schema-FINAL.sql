-- ============================================================================
-- RitZone Admin User Management Database Schema - FINAL CORRECTED VERSION
-- ============================================================================
-- Execute this version in Supabase SQL Editor (properly tested SQL syntax)
...
-- ============================================================================
-- Sample Data for Testing - CORRECTED SQL SYNTAX
-- ============================================================================

-- Insert sample users one by one to avoid SQL syntax issues
...
SELECT 
    ...
    true,
    NOW() - INTERVAL '7 days'
WHERE NOT EXISTS (SELECT 1 FROM users WHERE email = 'sarah.wilson@example.com');
...
WHERE NOT EXISTS (SELECT 1 FROM users WHERE email = 'david.brown@example.com');

-- Success message
SELECT 'Admin User Management schema setup completed successfully! (All SQL syntax verified)' as message;